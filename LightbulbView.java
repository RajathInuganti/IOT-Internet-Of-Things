...
public class LightbulbView {
  ...
  private LightbulbController ccontroller;
  private WebClientController controller;

  public LightbulbView(LightbulbController ccontroller, WebClientController wcontroller,
  ...
  private void createAndLayoutControls() {
    ...
    view.addRow(0, new Label("Number of Devices:" + controller.getNumber("Lightbulb")));

    int row = 1;

    @SuppressWarnings("unchecked")
    LinkedList<Device> devices = (LinkedList<Device>) controller.GetDeviceInfo("Lightbulb");
    for (int num = 0; num < devices.size(); num++) {
      ...
      StartButton.setOnAction(new EventHandler<ActionEvent>() {
        ...
        public void handle(ActionEvent event) {
          ccontroller.toggleStart((Lightbulb) c);
